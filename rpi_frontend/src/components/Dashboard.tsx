...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-4 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <div className="flex items-center gap-3">
            <LayoutDashboard className="w-8 h-8 text-rpi-blue" />
            <h2 className="text-2xl font-bold text-gray-900">Trámites en Proceso</h2>
          </div>
          <p className="text-sm text-rpi-gray/60 mt-1">Gestión de trámites registral</p>
        </div>
      ...
      {/* Tabla de Trámites */}
      <div className="bg-white rounded-xl shadow-lg border border-rpi-gray/20 overflow-hidden">
        <div className="px-6 py-4 bg-gradient-to-r from-rpi-blue to-blue-800">
          <h3 className="text-white font-semibold text-lg">Lista de Trámites</h3>
        </div>
              ...
              {tramites.map((tramite) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {tramite.fecha_ingreso ? new Date(tramite.fecha_ingreso).toLocaleDateString('es-AR', {
                      day: '2-digit',
                      month: '2-digit',
                      year: 'numeric'
                    }) : '-'}
